...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { description: @speaker.description, event_id: @speaker.event_id, name: @speaker.name, surname: @speaker.surname }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { description: @speaker.description, event_id: @speaker.event_id, name: @speaker.name, surname: @speaker.surname }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
