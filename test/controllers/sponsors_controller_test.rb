...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { amount: @sponsor.amount, description: @sponsor.description, event_id: @sponsor.event_id, form: @sponsor.form, name: @sponsor.name }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { amount: @sponsor.amount, description: @sponsor.description, event_id: @sponsor.event_id, form: @sponsor.form, name: @sponsor.name }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
